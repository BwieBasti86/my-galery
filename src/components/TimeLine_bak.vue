<template>
  ...
  <v-row>
    <v-col>
      ...
      <v-row>
        <v-col>
          <template style="position:absolute;overflow-y: scroll">
                ...
                >
                  ...
                  >
                    ...
                    <h5
                      ...
                      class="white--text font-weight-light"
                    >
                    {{ `${item.title} ${isPdfView ? this.dates.from:null}` }}
                    </h5>
                  ...
                  <v-container >
                    <v-row>
                      <v-col :class="isPdfView ? 'pa-0' : null" cols="12" md="10" style="font-size:small">
                        <v-list-item>
